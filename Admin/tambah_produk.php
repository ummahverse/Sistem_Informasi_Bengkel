...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert query - removed deskripsi and satuan
    $query = "INSERT INTO produk (nama, kategori_id, harga_beli, harga_jual, stok) 
              VALUES ('$nama', $kategori_id, '$harga_beli', '$harga_jual', '$stok')";
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $_SESSION['message'] = "Gagal menambahkan produk: " . mysqli_error($conn);
...
<head>
  ...
  <title>Tambah Produk Baru - Kasir Bengkel</title>
              ...
              <div class="form-section">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <span class="input-group-text">Rp</span>
                      <input type="text" class="form-control currency" id="harga_jual" name="harga_jual" required>
                    </div>
              ...
              <div class="form-section">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-text">Masukkan jumlah stok awal.</div>
                  </div>
                </div>
              </div>
